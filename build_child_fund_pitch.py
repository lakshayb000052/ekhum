...
COLOR_BORDER_EMERALD = RGBColor(167, 243, 208) # #A7F3D0 (Emerald Border Accent)
...
HERO_UI_PATH = r"C:\Users\laksh\.gemini\antigravity\brain\ba481067-c2ec-47d3-8538-41292137446b\childfund_hero_ui_1787080439936.jpg"
...
# ==============================================================================
# SLIDE 1: TITLE SLIDE (Executive Presentation Cover)
# ==============================================================================
...
# Title text box
tb1 = slide1.shapes.add_textbox(Inches(1.0), Inches(1.3), Inches(7.5), Inches(5.0))
tf1 = tb1.text_frame
tf1.word_wrap = True

p_badge = tf1.paragraphs[0]
p_badge.text = "CHAOS DESIGN PLATFORM  •  INDIVIDUAL GIVING FUNDRAISING SUITE"
p_badge.font.size = Pt(11.5)
...
p_footer.text = "Presented by: EKhum by CHAOS  |  Giving Fintech Operating System\nMulti-Gateway  •  Visual WhatsApp Journeys  •  Section 80G & 10BD Statutory Engine  •  0.0% Fee"
...
if os.path.exists(LOGO_PATH):
    slide1.shapes.add_picture(LOGO_PATH, Inches(8.5), Inches(1.8), width=Inches(4.4), height=Inches(3.8))
...
add_slide_header(slide2, "Executive Overview", "Transforming ChildFund's Digital Giving Ecosystem", "How EKhum accelerates child sponsorship acquisition, retention, and donor trust across India.")

cards_data2 = [
    ("⚡ Mission-Critical Reliability", "Multi-Gateway Redundancy", "Integrated across Razorpay, PayU, CCAvenue, and Worldline for zero transaction drop-offs, automatic failover, and smart recurring retry mechanisms for monthly sponsorship debits."),
    ("🎯 Automated Donor Engagement", "Visual WhatsApp & Email Journeys", "Visual drag-and-drop lifecycle builder delivering child impact updates, school report cards, milestone celebrations, and automated mandate failure recovery via WhatsApp Cloud API."),
    ("📜 Frictionless Tax Compliance", "Instant 80G & Form 10BD Engine", "Automated real-time 80G receipt PDF generation with QR verification + 1-click annual Form 10BD export for seamless Income Tax Department filing with zero support overhead.")
]
...
# ==============================================================================
# SLIDE 3: CHILDFUND KEY FUNDRAISING CHALLENGES
# ==============================================================================
slide3 = prs.slides.add_slide(blank_slide_layout)
set_slide_background(slide3, COLOR_BG_LIGHT)
add_slide_header(slide3, "The Opportunity", "Addressing Key Bottlenecks in Child Sponsorship Giving", "Analyzing systemic friction points in traditional nonprofit donor management.")

challenges = [
    ("🛑 Mandate Attrition & Silent Failures", "UPI Autopay and ENACH mandate failures often go unrecovered due to delayed manual outreach, resulting in a 25-35% annual drop-off in active recurring child sponsorship pledges."),
    ("💸 Single Gateway Vulnerability", "Dependency on a single payment aggregator causes critical donation losses during gateway downtimes or bank maintenance windows during peak giving campaigns and festivals."),
    ("⏳ March Tax Season Overload", "Manual generation and dispatch of Section 80G tax certificates overwhelm administrative teams in March, leading to delayed receipts and donor dissatisfaction."),
    ("📉 Disconnected Communication Channels", "Donors rarely receive continuous, transparent visual updates on the child they sponsor, leading to emotional detachment and lapsed recurring pledges.")
]
...
# ==============================================================================
# SLIDE 4: THE SOLUTION — EKHUM PLATFORM ARCHITECTURE
# ==============================================================================
...
features4 = [
    ("💳 4-Way Multi-Gateway Hub", "Razorpay, PayU, CCAvenue & Worldline routing with auto-fallback, UPI Autopay, and unified reconciliation."),
    ("🤖 Visual Journey Builder", "Drag-and-drop workflow canvas for multi-step WhatsApp and Email donor nurture journeys."),
    ("⚡ Real-Time Event Bus", "11 instant trigger events connecting donor actions to automated lifecycle responses within milliseconds."),
    ("📜 Automated 80G & 10BD Engine", "Instant statutory receipts with QR verification snapshots and automated annual Income Tax Form 10BD export.")
]
...
# Add ChildFund Hero UI Graphic on Right of Slide 4
if os.path.exists(HERO_UI_PATH):
    slide4.shapes.add_picture(HERO_UI_PATH, Inches(7.8), Inches(1.8), width=Inches(4.7), height=Inches(4.8))

# ==============================================================================
# SLIDE 5: MULTI-GATEWAY INFRASTRUCTURE & SMART ROUTING
# ==============================================================================
...
gateways = [
    ("Razorpay", "UPI Autopay, Cards, Netbanking", "Primary gateway for online donation checkouts with instant webhook event ingestion and high mobile conversion."),
    ("PayU India", "ENACH Mandates, Subscriptions", "Secondary failover routing for recurring child sponsorship debits with exceptional bank success rates."),
    ("CCAvenue", "Multi-Bank E-Mandates, 50+ Banks", "Deep tier-2/3 Indian bank coverage ensuring regional and rural donors can set up automatic sponsorship pledges."),
    ("Worldline", "Direct Debit Cards, POS & Offline", "Enterprise payment gateway processing large corporate CSR giving, POS drives, and offline bank reconciliation.")
]
...
# ==============================================================================
# SLIDE 6: VISUAL JOURNEY BUILDER (WHATSAPP + EMAIL)
# ==============================================================================
...
journey_steps = [
    ("1. Entry Trigger", "🎯 Event Triggered", "Sponsor signs up for 'Educate a Girl Child' campaign via website or QR code."),
    ("2. Immediate Action", "📧 Email Welcome Kit", "Dispatches personalized welcome kit with child bio, photo, and 80G receipt attachment."),
    ("3. Time Delay", "⏳ Wait 48 Hours", "System pauses to allow donor to absorb impact materials before next touchpoint."),
    ("4. Mobile Nudge", "💬 WhatsApp Video", "Sends a warm 30-second introduction video update from the ChildFund field coordinator."),
    ("5. Smart Split", "🔀 Condition Branch", "Checks if monthly donation > ₹5,000 to route to Major Donor relationship officer.")
]
...
# ==============================================================================
# SLIDE 7: REAL-TIME EVENT TRIGGER ENGINE
# ==============================================================================
slide7 = prs.slides.add_slide(blank_slide_layout)
set_slide_background(slide7, COLOR_BG_LIGHT)
add_slide_header(slide7, "Automation Architecture", "Real-Time Event Trigger Engine (11 System Events)", "Native event bus connecting real-time donor actions to autonomous giving workflows.")

events_list = [
    ("donation.completed", "Fires on successful payment; auto-issues 80G receipt PDF and triggers welcome nurture series."),
    ("donation.failed", "Fires when card or UPI payment drops; immediately dispatches 1-click retry WhatsApp link within 60s."),
    ("subscription.created", "Fires on new recurring child sponsorship pledge; enrols sponsor into monthly child progress journey."),
    ("subscription.cancelled", "Fires when recurring pledge is cancelled; initiates compassionate win-back feedback survey."),
    ("mandate.failed", "Fires when monthly bank auto-debit bounces; initiates automated 3-day recovery sequence with alternate UPI prompt."),
    ("receipt.generated", "Fires when 80G certificate PDF is rendered; delivers instant statutory PDF attachment to donor inbox & WhatsApp.")
]
...
# ==============================================================================
# SLIDE 8: AUTOMATED 80G TAX COMPLIANCE & FORM 10BD
# ==============================================================================
...
tax_cards = [
    ("📜 Instant 80G Receipts", "Automated PDF Generation", "Every donation automatically generates a verifiable Section 80G PDF with child sponsorship details, donor PAN, organization 80G URN, and authorized signatory snapshot delivered in seconds."),
    ("📤 1-Click Form 10BD Filing", "Income Tax Portal Export", "One-click export strictly formatted according to the Income Tax Department's Form 10BD schema, completely eliminating manual data formatting, missing PANs, and reconciliation errors."),
...
# ==============================================================================
# SLIDE 9: CHILDFUND SPONSORSHIP CRM & DATA MODEL
# ==============================================================================
...
# ==============================================================================
# SLIDE 10: IMPACT & ROI PROJECTIONS
# ==============================================================================
slide10 = prs.slides.add_slide(blank_slide_layout)
set_slide_background(slide10, COLOR_BG_LIGHT)
add_slide_header(slide10, "Business Case & Impact", "Projected ROI & Key Metric Improvements", "Quantifiable efficiency gains within the first 6 months of deployment for ChildFund.")
...
# ==============================================================================
# SLIDE 11: SECURITY, DATA SOVEREIGNTY & DPDP ACT
# ==============================================================================
...
# ==============================================================================
# SLIDE 12: DEPLOYMENT ROADMAP & NEXT STEPS
# ==============================================================================
...
output_ppt_brain = r"C:\Users\laksh\.gemini\antigravity\brain\ba481067-c2ec-47d3-8538-41292137446b\child_fund_pitch.ppt"
output_pptx_brain = r"C:\Users\laksh\.gemini\antigravity\brain\ba481067-c2ec-47d3-8538-41292137446b\child_fund_pitch.pptx"
...
print(f"SUCCESS: Generated {output_ppt_workspace} and {output_pptx_workspace}")
